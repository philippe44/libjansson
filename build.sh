...
declare -A cppflags=( [sparc64-linux-gnu-gcc]="-mcpu=v7" [mips-linux-gnu-gcc]="-march=mips32" [powerpc-linux-gnu-gcc]="-m32" [x86_64-solaris-gnu-gcc]=-mno-direct-extern-access )
declare -a compilers
